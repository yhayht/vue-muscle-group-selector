import { openBlock as m, createElementBlock as f, createElementVNode as e, toDisplayString as n, normalizeStyle as l, normalizeClass as s, ref as b, onMounted as M, useCssVars as p } from "vue";
const C = (t, i) => {
  ...
  props: {
     ...
     * the user can only select one muscle group.
     */
    allowMultiple: {
      type: Boolean,
      default: !1
    ...
    /**
     * The primary color of the component, this is the color of the
     ...
     * ID of the muscle group, not the name.
     */
    initialValues: {
      type: Array,
      default: () => []
    ...
    /**
     * If true, the helper list of the muscle groups will be shown,
     * if false, the helper list will be hidden.
     */
    ...
    /**
     * If true, the legs muscle groups will be shown, if false, the
     * legs muscle groups will be hidden.
     */
    showBackMuscles: {
      type: Boolean,
      default: !0
    ...
    /**
     * If true, the back muscle groups will be shown, if false, the
     * back muscle groups will be hidden.
     */
    showFrontMuscles: {
      type: Boolean,
      default: !0
    ...
    /**
     * Use with the initial values to only show the selected muscle group
     */
    readOnly: {
      type: Boolean,
      default: !1
    ...
    /**
     * The translations of the muscle groups, the keys are the IDs of
     * the muscle groups, the values are the names of the muscle groups.
     */
    translations: {
      type: Object,
      default: () => ({
  ...
  setup(t, { emit: i }) {
    const c = b("center"), u = b("absolute"), a = () => {
      const r = document.querySelectorAll(
        '.muscle-groups input[type="checkbox"]:checked'
      ), o = Array.from(r).map((d) => d.id);
      i("onSelect", o);
    };
    return M(() => {
      t.initialValues.forEach((o) => {
        document.getElementById(o) && (document.getElementById(o).checked = !0);
      });
      const r = document.querySelectorAll(
      ...
      }), document.querySelectorAll(".muscle-groups svg g g[id]").forEach(function(o) {
        o.addEventListener("click", function(d) {
          if (t.readOnly)
            return;
          let _ = d.target.parentNode.id.toLowerCase();
          _ || (_ = d.target.parentNode.parentNode.id.toLowerCase());
          let h = document.getElementById(_);
          t.allowMultiple ? (h.checked ? h.checked = !1 : h.checked = !0, a()) : (document.querySelectorAll(".muscle-groups input").forEach(function(v) {
            v.checked = !1;
          }), h.checked = !0, a());
        });
      }), t.showMusclesListHelper || (document.querySelectorAll(".muscle-groups-container label").forEach((o) => {
        o.style.display = "none";
      }), document.querySelectorAll(".muscle-groups-container h2.list-title").forEach((o) => {
        o.style.display = "none";
      }), c.value = "normal", u.value = "none"), t.showFrontMuscles || (document.querySelector(
        ".muscle-groups-container #Front-Muscles"
      ).style.display = "none", document.querySelector(
        ".muscle-groups-container path#Front"
      ).style.display = "none"), t.showBackMuscles || (document.querySelector(
        ".muscle-groups-container #Back-Muscles"
      ).style.display = "none", document.querySelector(
        ".muscle-groups-container path#Back"
      ).style.display = "none"), !t.showFrontMuscles && t.showBackMuscles && (document.querySelector(
        ".muscle-groups-container #Back-Muscles"
      ).style.transform = "translate(-100px, 0px)", document.querySelector(
        ".muscle-groups-container path#Back"
      ).style.transform = "translate(-100px, 0px)");
    }), {
      primaryColorBind: t.primaryColor,
      musculeGroupsContainerAlignItemsBind: c,
      musculeGroupsSVGPositionBind: u
    };
  }
}, g = () => {
  p((t) => ({
    "3b9a5d74": t.primaryColorBind,
    "1e8bb116": t.musculeGroupsSVGPositionBind,
    b5ab8df6: t.musculeGroupsContainerAlignItemsBind
  }));
}, k = y.setup;
y.setup = k ? (t, i) => (g(), k(t, i)) : g;
const O = y, x = { class: "muscle-groups-container" }, B = { class: "muscle-groups" }, Z = { class: "list-title" }, w = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "biceps muscles-helper",
  id: "biceps"
}, null, -1), S = { for: "biceps" }, q = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "deltoids muscles-helper",
  id: "deltoids"
}, null, -1), A = { for: "deltoids" }, E = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "forearms muscles-helper",
  id: "forearms"
}, null, -1), G = { for: "forearms" }, F = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "triceps muscles-helper",
  id: "triceps"
}, null, -1), z = { for: "triceps" }, L = { class: "list-title" }, V = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "trapezius muscles-helper",
  id: "trapezius"
}, null, -1), I = { for: "trapezius" }, T = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "lats muscles-helper",
  id: "lats"
}, null, -1), H = { for: "lats" }, N = { class: "list-title" }, P = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "abs muscles-helper",
  id: "abs"
}, null, -1), j = /* @__PURE__ */ e("label", { for: "abs" }, "Abs", -1), D = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "obliques muscles-helper",
  id: "obliques"
}, null, -1), Q = { for: "obliques" }, R = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "pectorals muscles-helper",
  id: "pectorals"
}, null, -1), J = { for: "pectorals" }, K = { class: "list-title" }, U = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "adductors muscles-helper",
  id: "adductors"
}, null, -1), W = { for: "adductors" }, X = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "calves muscles-helper",
  id: "calves"
}, null, -1), Y = { for: "calves" }, $ = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "hamstrings muscles-helper",
  id: "hamstrings"
}, null, -1), e1 = { for: "hamstrings" }, c1 = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "glutes muscles-helper",
  id: "glutes"
}, null, -1), l1 = { for: "glutes" }, s1 = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "quads muscles-helper",
  id: "quads"
}, null, -1), t1 = { for: "quads" }, n1 = /* @__PURE__ */ e("input", {
  type: "checkbox",
  class: "feet muscles-helper",
  id: "feet"
}, null, -1), o1 = { for: "feet" }, a1 = /* @__PURE__ */ e("rect", {
  id: "Artboard1",
  x: "0",
  y: "0",
  width: "175.551",
  height: "206.785",
  style: { fill: "none" }
}, null, -1), i1 = { id: "Back-Muscles" }, d1 = { id: "Trapezius" }, u1 = { id: "Lats" }, r1 = { id: "Triceps" }, h1 = { id: "Forearms" }, _1 = { id: "Glutes" }, y1 = { id: "Hamstrings" }, m1 = { id: "Calves" }, f1 = { id: "Feet" }, b1 = { id: "Front-Muscles" }, g1 = { id: "Deltoids" }, k1 = { id: "Biceps" }, v1 = { id: "Pectorals" }, M1 = { id: "Obliques" }, p1 = { id: "Abs" }, C1 = { id: "Quads" }, O1 = { id: "Adductors" };
function x1(t, i, c, u, a, r) {
  return m(), f("main", x, [
    e("div", B, [
      e("h2", Z, n(c.translations.arms.arms), 1),
      w,
      e("label", S, n(c.translations.arms.biceps), 1),
      q,
      e("label", A, n(c.translations.arms.deltoids), 1),
      E,
      e("label", G, n(c.translations.arms.forearms), 1),
      F,
      e("label", z, n(c.translations.arms.triceps), 1),
      e("h2", L, n(c.translations.back.back), 1),
      V,
      e("label", I, n(c.translations.back.trapezius), 1),
      T,
      e("label", H, n(c.translations.back.lats), 1),
      e("h2", N, n(c.translations.core.core), 1),
      P,
      j,
      D,
      e("label", Q, n(c.translations.core.obliques), 1),
      R,
      e("label", J, n(c.translations.core.pectorals), 1),
      e("h2", K, n(c.translations.legs.legs), 1),
      U,
      e("label", W, n(c.translations.legs.adductors), 1),
      X,
      e("label", Y, n(c.translations.legs.calves), 1),
      $,
      e("label", e1, n(c.translations.legs.hamstrings), 1),
      c1,
      e("label", l1, n(c.translations.legs.glutes), 1),
      s1,
      e("label", t1, n(c.translations.legs.quads), 1),
      n1,
      e("label", o1, n(c.translations.legs.feet), 1),
      (m(), f("svg", {
        width: "100%",
        height: "100%",
        viewBox: "0 0 176 207",
        ...
        e("g", i1, [
          e("g", null, [
            e("g", d1, [
              e("g", null, [
                e("path", {
                  class: s(`${c.readOnly ? "disabled-pointer-events" : null} Trapezius`),
                  ...
                  style: l(`fill: ${c.muscleColor}`)
                }, null, 6)
              ])
            ]),
            e("g", u1, [
              e("path", {
                class: s(`${c.readOnly ? "disabled-pointer-events" : null}`),
        ...
        e("path", {
          ...
          style: l(`fill: none; stroke: ${c.strokeColor}; stroke-width: 1px`)
        }, null, 4),
        e("path", {
          id: "Back",
...
const Z1 = /* @__PURE__ */ C(O, [["render", x1]]);
export {
  Z1 as default
};
